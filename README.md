...
pixi add openmm-nonbonded-slicing
# for installing globally
pixi global install openmm-nonbonded-slicing
```
...
It is possible to list all of the versions of `openmm-nonbonded-slicing` available on your platform:
...
```
pixi search openmm-nonbonded-slicing --channel conda-forge
```
